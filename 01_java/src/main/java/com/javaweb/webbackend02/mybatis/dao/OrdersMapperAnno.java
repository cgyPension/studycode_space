...
public interface OrdersMapperAnno {
    ...
    @Results({ //代替的就是resultMap标签id标签 result标签
            ...
            @Result(property="user",javaType = User.class,column = "uid",one = @One(select = "com.javaweb.webbackend02.mybatis.dao.UserMapperAnno.selectAllWhereId",fetchType = FetchType.EAGER)),
    })
