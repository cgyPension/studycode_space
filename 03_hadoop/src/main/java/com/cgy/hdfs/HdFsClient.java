...
public class HdFsClient {
    ...
    public void getFile() throws Exception {
        ...
        // 获取文件系统对象
        FileSystem fs = FileSystem.get(uri, conf, "cgy");
        // 操作文件系统的数据
    ...
    public void delFile() throws Exception {
        ...
        URI uri=new URI("hdfs://hadoop102:9820");
        Configuration configuration=new Configuration();
        FileSystem fs = FileSystem.get(uri, configuration, "cgy");
    ...
    public void init() throws Exception {
       ...
       fs = FileSystem.get(uri, configuration, "cgy");
    }
    @After
